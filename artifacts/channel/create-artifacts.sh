...
rm genesis.block master-channel.tx
...
# channel name defaults to "master-channel"
CHANNEL_NAME="master-channel"
...
configtxgen -profile BasicChannel -configPath . -outputCreateChannelTx ./master-channel.tx -channelID $CHANNEL_NAME
